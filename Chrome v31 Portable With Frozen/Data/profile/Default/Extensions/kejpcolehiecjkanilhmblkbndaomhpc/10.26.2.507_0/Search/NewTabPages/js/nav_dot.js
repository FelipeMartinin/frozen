...
cr.define('ntp', function() {
  ...
  NavDot.prototype = {
     ...
     */
    switchToPage: function(switchType) {
      ntp.getCardSlider().selectCardByValue(this.page_, switchType, true);
    },
    ...
    onClick_: function(e) {
    	if (!e.switchType)
    		e.switchType = 'click';
      this.switchToPage(e.switchType);
