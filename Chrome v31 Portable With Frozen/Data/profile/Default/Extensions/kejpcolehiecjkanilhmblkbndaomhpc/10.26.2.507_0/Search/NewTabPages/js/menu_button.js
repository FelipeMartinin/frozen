...
cr.define('cr.ui', function() {
  ...
  MenuButton.prototype = {
    ...
    hideMenuFromIframe: function() {
        var menuButton = parent.document.getElementById("recently-closed-menu-button");
        if (menuButton.hasAttribute('menu-shown')) {
            menuButton.removeAttribute('menu-shown');
            menuButton.menu.style.display = 'none';
        };
    },
    /**
