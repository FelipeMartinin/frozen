...
cr.define('ntp', function() {
  ...
  RecentMenuButton.prototype = {
    ...
    showMenu: function() {
     ...
     conduit.newtab.usage.CallUsage('RecentlyClosed_Click_link');
    ...
    set dataItems(dataItems) {
      ...
      this.needsRebuild_ = true;
      if (dataItems.length) {
        this.setAttribute('itemsLength',dataItems.length);
    ...
    addItem_: function(data) {
      ...
      function onClick(e) {
       conduit.newtab.usage.CallUsage('RecentlyClosed_Click_linkInside');
        conduit.newtab.recentlyClosed.openRecentlyClosed(e.srcElement.id);
        //e.preventDefault();
      }
