...
cr.define('alertOverlay', function () {
   ...
   */
   ...
   function initialize(e) {
      okButton = document.getElementById('alertOverlayOk');
      cancelButton = document.getElementById('alertOverlayCancel');
   ...
   */
   function setValues(
      ...
      document.getElementById('alertOverlayTitle').hidden = typeof title == 'undefined';

      if (typeof message != 'undefined')
         document.getElementById('alertOverlayMessage').textContent = message;
      document.getElementById('alertOverlayMessage').hidden = typeof message == 'undefined';
